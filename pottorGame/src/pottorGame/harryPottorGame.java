												...
												if (attack>defence)
													{
														...
														JOptionPane.showMessageDialog(frame, "the spell hit Rose straight in the chest before she could cast the counter Charm");
										...
										else if (spell.equals("23999stpfy9"))
											{
												...
												if (counterChance>stAttack)
												...
												else
													{
														...
														JOptionPane.showMessageDialog(frame, "beacuse she failed to block the spell she is aslo stuned");
													}
												playerTurn = false;
										...
										if (spell.equals("1167gmnt"))
											{
												...
												if (block>opattack)
													...
													{
														JOptionPane.showMessageDialog(frame, "your counter spell missed and her flames flew past your water and hit you straight in chest");
														JOptionPane.showMessageDialog(frame, "you had " + wiz.getHealth() + " Health");
